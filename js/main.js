$(function() {
  ...
  $window.keydown(function(event) {
    ...
    if (event.which === 13) {
      ...
      socket.on('login', function(result) { //this waits for a reply from the server after checking that the given username is available or not......result is a boolean

        // here if result is true setUsername otherwise ask again.......
